...
<body>
	...
	<form action="#" name="form1">
		...
		<table class="main" border="2">
			...
			<tr>
				...
				<td><input type="text" name="name" size="8" value=""
					placeholder="氏名"></td>
			...
			<tr>
				...
				<td colspan="2"><s:property value="iDraftingId" /></td>

				<th>決裁番号</th>

				<td colspan="2"><s:property value="iApprovalId" /></td>

				<th colspan="2">実施時期・実施機関</th>

				<td colspan="3"><input type="date" name="example"
					value="<s:property value="startDay" />" required>~ <input
					type="date" name="example2" value="<s:property value="endDay" />"
					required></td>
			...
			<tr>
				<th class="anken">案件名</th>

				<td colspan="3"><textarea cols="32" rows="4" name="案件名"
						value="<s:property value="decisionName" />"></textarea></td>
			...
			<tr>
				<th>概要</th>
				<td colspan="10"><textarea cols="124"
						value="<s:property value="summary" />" rows="4" name="案件名"></textarea></td>
			...
			<tr>
				<th>理由・目的</th>
				<td colspan="10"><textarea cols="124"
						value="<s:property value="cause" />" rows="4" name="案件名"></textarea></td>
		...
		<table class="sub" border="2">
			...
			<tr>
				...
				<td><input type="number" name="field1" size="8" value=""
			...
			<tr>
				...
				<td><input type="number" name="field2" size="8" value=""
					readonly="readonly">万円</td>
			...
			<tr>
				...
				<td><input type="number" name="field3" size="8" value=""
					readonly="readonly">万円</td>
			...
			<tr>
				...
				<td><input type="number" name="field4" size="8" value="55.5"
					readonly="readonly">万円</td>
		...
		<table class="math" border="2">
			...
			<tr>
				...
				<td><input type="number" name="goods5" id="c" value=""
					onChange="calculation()" readonly="readonly"></td>
				<td><input type="number" name="field5" size="8" value=""
					readonly="readonly">万円</td>
			...
			<tr>
				...
				<td><input type="number" name="goods6" id="d" value=""
					onChange="calculation()" readonly="readonly"></td>
				<td><input type="number" name="field6" size="8" value=""
					readonly="readonly">万円</td>
	...
	<div class="save">
		<s:form action="DcisionUpdateAction">
			<input type="submit" value="編集を保存" name="save">
